          ...
          <div className="row gy-4 justify-content-center">
            <div className="col-lg-3 col-sm-6">
              <div className="single-fact-wrap">
                <div className="thumb">
                  <img src="assets/img/fact/1.png" alt="Rapid Fix" />
                </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="single-fact-wrap">
                <div className="thumb">
                  <img src="assets/img/fact/2.png" alt="Rapid Fix" />
                </div>
                <div className="details">
                  <h2>
                    <TrackVisibility once>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="single-fact-wrap">
                <div className="thumb">
                  <img src="assets/img/fact/3.png" alt="Rapid Fix" />
                </div>
                <div className="details">
                  <h2>
                    <TrackVisibility once>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="single-fact-wrap">
                <div className="thumb">
                  <img src="assets/img/fact/4.png" alt="Rapid Fix" />
                </div>
                <div className="details">
                  <h2>
                    <TrackVisibility once>
          ...
          >
            <SwiperSlide>
              <div>
                <div className="single-intro-wrap">
                  <div className="thumb">
                    <img src="assets/img/intro/4.png" alt="Rapid Fix" />
                  </div>
                  <div className="details">
            ...
            <SwiperSlide>
              <div>
                <div className="single-intro-wrap">
                  <div className="thumb">
                    <img src="assets/img/intro/5.png" alt="Rapid Fix" />
                  </div>
                  <div className="details">
            ...
            <SwiperSlide>
              <div>
                <div className="single-intro-wrap style-2">
                  <div className="thumb">
                    <img src="assets/img/intro/6.png" alt="Rapid Fix" />
                  </div>
                  <div className="details">
