              ...
              >
                <SwiperSlide>
                  <div>
                    <div className="client-logo">
                      <Link href="#">
                        <img src="assets/img/client/1.png" alt="Rapid Fix" />
                      </Link>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div>
                    <div className="client-logo">
                      <Link href="#">
                        <img src="assets/img/client/2.png" alt="Rapid Fix" />
                      </Link>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div>
                    <div className="client-logo">
                      <Link href="#">
                        <img src="assets/img/client/3.png" alt="Rapid Fix" />
                      </Link>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div>
                    <div className="client-logo">
                      <Link href="#">
                        <img src="assets/img/client/4.png" alt="Rapid Fix" />
                      </Link>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div>
                    <div className="client-logo">
                      <Link href="#">
                        <img src="assets/img/client/5.png" alt="Rapid Fix" />
                      </Link>
                    </div>
                  </div>
                </SwiperSlide>
